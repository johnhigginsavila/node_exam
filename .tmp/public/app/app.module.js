...
var router_config_1 = require("./router-config/router.config");
var app_component_1 = require("./app.component");
var services_module_1 = require("./services/services.module");
var feature_module_1 = require("./feature-component/feature.module");
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        imports: [
            ...
            services_module_1.ServiceModule.forRoot(),
